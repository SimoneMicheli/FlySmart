...
per configurare il logger entrare nelle proprietˆ del progetto -> java build path -> Libraries
...
Posizionarlo in una cartella vicino al progetto ad esempio se il progetto  in documenti/FlySmart posizionare il db in documenti/mongodb
Creare una cartella data in FlySmart/FlySmart (cio FlySmart/FlySmart/data)
